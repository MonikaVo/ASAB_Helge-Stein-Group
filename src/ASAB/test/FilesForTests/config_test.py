...
auxiliaryFolderHardware = "ASAB\\test\\FilesForTests" # edited prior to publication
...
config["CetoniDeviceDriver"] = {"availableSyringes": auxiliaryFolderHardware + "\\syringes_test.txt",
                    ...
                    "pumps": auxiliaryFolderHardware + "\\Pumps_test.txt",
                    "valves": auxiliaryFolderHardware + "\\Valves_test.txt",
                    "channels": auxiliaryFolderHardware + "\\Channels_test.txt",
                    "valvePositionDict": auxiliaryFolderHardware + "\\valvePositionDict_test.txt",
                    "setup": auxiliaryFolderHardware + "\\setup_test.txt",
                    "flow": 0.03,
                    ...
                    "faultState": False,
                    "valvePos": 0},
                    "valveInit": {"target": ['actual_valve_position', 'close', 'get_device_name', 'get_device_property', 'get_error_message', 'get_no_of_valves', 'get_node_id', 'handle', 'lookup_by_device_index', 'lookup_by_name', 'name', 'number_of_valve_positions', 'open', 'read_last_error', 'read_last_error_code', 'set_communication_state', 'set_device_property', 'switch_valve_to_position']},
...
config["syringes"] = {"savePath": auxiliaryFolderHardware + "\\syringes_test.txt",
...
config["graph"] = {"pathNodes": auxiliaryFolderHardware + "\\nodes_test.csv",
                    ...
                    "savePath": auxiliaryFolderHardware + "\\setup_test.txt",
                    "saveNameValvePositionDict": auxiliaryFolderHardware + "\\valvePositionDict_test.txt",
                    ...
                    "testInput": {"findClosest": {"node": "nmrOUT", "candidates": ["A0.0", "B0.0", "C0.0", "D0.0", "E0.0", "F0.0"]},
                        ...
                        "edges": [("V1.0", "V1.1", {"name": "0004-XX-1", "designation": ("V1.0", "V1.1"), "ends": "XX", "length": float(4.33), "diameter": float(0.5), "dead_volume": float(0.0116), "status": "empty"}),
                        ("V1.1", "V1.0", {"name": "0004-XX-1", "designation": ("V1.1", "V1.0"), "ends": "XX", "length": float(4.33), "diameter": float(0.5), "dead_volume": float(0.0116), "status": "empty"}),
                        ("V1.0", "V1.2", {"name": "0004-XX-2", "designation": ("V1.0", "V1.2"), "ends": "XX", "length": float(4.33), "diameter": float(0.5), "dead_volume": float(0.0116), "status": "empty"}),
                        ("V1.2", "V1.0", {"name": "0004-XX-2", "designation": ("V1.2", "V1.0"), "ends": "XX", "length": float(4.33), "diameter": float(0.5), "dead_volume": float(0.0116), "status": "empty"}),
                        ("V1.0", "V1.3", {"name": "0004-XX-3", "designation": ("V1.0", "V1.3"), "ends": "XX", "length": float(4.33), "diameter": float(0.5), "dead_volume": float(0.0116), "status": "empty"}),
                        ("V1.3", "V1.0", {"name": "0004-XX-3", "designation": ("V1.3", "V1.0"), "ends": "XX", "length": float(4.33), "diameter": float(0.5), "dead_volume": float(0.0116), "status": "empty"}),
                        ("V1.0", "V1.4", {"name": "0004-XX-4", "designation": ("V1.0", "V1.4"), "ends": "XX", "length": float(4.33), "diameter": float(0.5), "dead_volume": float(0.0116), "status": "empty"}),
                        ("V1.4", "V1.0", {"name": "0004-XX-4", "designation": ("V1.4", "V1.0"), "ends": "XX", "length": float(4.33), "diameter": float(0.5), "dead_volume": float(0.0116), "status": "empty"}),
                        ("V1.0", "V1.5", {"name": "0004-XX-5", "designation": ("V1.0", "V1.5"), "ends": "XX", "length": float(4.33), "diameter": float(0.5), "dead_volume": float(0.0116), "status": "empty"}),
                        ("V1.5", "V1.0", {"name": "0004-XX-5", "designation": ("V1.5", "V1.0"), "ends": "XX", "length": float(4.33), "diameter": float(0.5), "dead_volume": float(0.0116), "status": "empty"}),
                        ("V6.6", "Q+Chip9", {"name": "0588-FT-8", "designation": ("V6.6", "Q+Chip9"), "ends": "FT", "length": float(588), "diameter": float(0.3), "dead_volume": float(0.0416), "status": "empty"}),
                        ("Q+Chip9", "V6.6", {"name": "0588-FT-8", "designation": ("Q+Chip9", "V6.6"), "ends": "FT", "length": float(588), "diameter": float(0.3), "dead_volume": float(0.0416), "status": "empty"}),
                        ("V5.6", "Q+Chip3", {"name": "0592-FT-3", "designation": ("V5.6", "Q+Chip3"), "ends": "FT", "length": float(592), "diameter": float(0.3), "dead_volume": float(0.0418), "status": "empty"}),
                        ("Q+Chip3", "V5.6", {"name": "0592-FT-3", "designation": ("Q+Chip3", "V5.6"), "ends": "FT", "length": float(592), "diameter": float(0.3), "dead_volume": float(0.0418), "status": "empty"}),
                        ("V6.8", "lambdaOUT", {"name": "0640-CT-2", "designation": ("V6.8", "lambdaOUT"), "ends": "CT", "length": float(640), "diameter": float(0.3), "dead_volume": float(0.0452), "status": "empty"}),
                        ("lambdaOUT", "V6.8", {"name": "0640-CT-2", "designation": ("lambdaOUT", "V6.8"), "ends": "CT", "length": float(640), "diameter": float(0.3), "dead_volume": float(0.0452), "status": "empty"}),
                        ("Ev1", "V1.5", {"name": "0286-NT-1", "designation": ("Ev1", "V1.5"), "ends": "NT", "length": float(286), "diameter": float(0.3), "dead_volume": float(0.0202), "status": "empty"}),
                        ("V1.5", "Ev1", {"name": "0286-NT-1", "designation": ("V1.5", "Ev1"), "ends": "NT", "length": float(286), "diameter": float(0.3), "dead_volume": float(0.0202), "status": "empty"})],
                        ...
                        "generateGraph": {"savePath": auxiliaryFolderHardware + "\\setup_generateGraph_test.txt"},
                        ...
                        "generateValvePositionDict": {"savePath": auxiliaryFolderHardware + "\\valvePositionDict_output.txt"},
                        ...
                        "getSystemStatus": auxiliaryFolderHardware + "\\setup_status_test.txt"},
                    "testOutput": {"findClosest":{"closest_target": "F0.0"},
                        "getEdgeDict": {"edgeDict_target": {'0215-NN-1': {'name': '0215-NN-1', 'designation': ('A0.0', 'A0.1'), 'ends': 'NN', 'length': 215.0, 'diameter': 0.3, 'dead_volume': 0.0152, 'status': 'empty'},
                        '0000-XX-1': {'name': '0000-XX-1', 'designation': ('A0.1', 'Av1'), 'ends': 'XX', 'length': 106.1, 'diameter': 0.6, 'dead_volume': 0.03, 'status': 'empty'},
                        '0502-NT-1': {'name': '0502-NT-1', 'designation': ('Av1', 'V1.1'), 'ends': 'NT', 'length': 502.0, 'diameter': 0.3, 'dead_volume': 0.0355, 'status': 'empty'},
                        '0004-XX-1': {'name': '0004-XX-1', 'designation': ('V1.1', 'V1.0'), 'ends': 'XX', 'length': 14.77, 'diameter': 1.0, 'dead_volume': 0.0116, 'status': 'empty'},
                        '0192-TT-1': {'name': '0192-TT-1', 'designation': ('V1.0', 'V2.0'), 'ends': 'TT', 'length': 192.0, 'diameter': 0.3, 'dead_volume': 0.0136, 'status': 'empty'},
                        '0004-XX-17': {'name': '0004-XX-17', 'designation': ('V2.0', 'V2.7'), 'ends': 'XX', 'length': 14.77, 'diameter': 1.0, 'dead_volume': 0.0116, 'status': 'empty'},
                        '0255-TT-1': {'name': '0255-TT-1', 'designation': ('V2.7', 'V3.0'), 'ends': 'TT', 'length': 255.0, 'diameter': 0.3, 'dead_volume': 0.018, 'status': 'empty'},
                        '0004-XX-21': {'name': '0004-XX-21', 'designation': ('V3.0', 'V3.1'), 'ends': 'XX', 'length': 14.77, 'diameter': 1.0, 'dead_volume': 0.0116, 'status': 'empty'},
                        '0476-CT-1': {'name': '0476-CT-1', 'designation': ('V3.1', 'Reservoir1'), 'ends': 'CT', 'length': 476.0, 'diameter': 0.3, 'dead_volume': 0.0336, 'status': 'empty'}}},
